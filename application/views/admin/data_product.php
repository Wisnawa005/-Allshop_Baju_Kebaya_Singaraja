											...
											<div class="modal-body">
												...
												<form action="<?= base_url('Admin/add_data_barang') ?>" method="post">
													<div class="form-group row">
														<label class="control-label col-md-3 col-sm-3 ">Kategori Barang<span class="required"> *</span></label>
														<div class="col-md-9 col-sm-9 ">
															<input type="text" name="ktbarang" id="ktbarang" required="required" class="form-control" placeholder="Masukkan Kategori Barang">
														</div>
													</div>
										...
										?>
											<tbody>
												<tr>
													...
													<td><?= $val->foto2 ?></td>
													<td>
														<?php echo anchor('admin/detail_product/' . $val->kode_barang, '<button type="button" class="btn btn-success"><i class="fas fa-eye"></i></button>') ?>
