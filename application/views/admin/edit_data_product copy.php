				...
				<div class="row">
					...
					<div class="col-3">
						<div class="card" style="width: 16rem;">
							...
							<div class="card-body">
								<p class="card-text">Update Gambar <input type="file" class="form-control" id="foto" name="foto" value="<?php echo $val->foto ?>"></input></p>
							</div>
						</div>
					</div>
					<div class="col-3">
						<div class="card" style="width: 16rem;">
							...
							<div class="card-body">
								<p class="card-text">Update Gambar 2 <input type="file" class="form-control" id="foto2" name="foto2" value="<?php echo $val->foto2 ?>"></input></p>
							</div>
						</div>
					</div>
					</form>
