			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="footer">
						...
						<div class="ft__details">
							<p>Website ini dikembangkan dalam tampung tugas yang berlaku. by: Wisnawa & Edy</p>
				...
				<div class="col-md-2 col-sm-6 col-xs-12 xmt-40 smt-40">
					<div class="footer">
						...
						<div class="ft__inner">
							<ul class="ft__list">
								<li><a href="<?= base_url('user/wishlist') ?>">My Account</a></li>
								<li><a href="<?= base_url('user/detail_keranjang_belanja') ?>">My Cart</a></li>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 xmt-40 smt-40">
					<div class="footer">
						<h2 class="title__line--2">Send Message </h2>
						<div class="ft__inner">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="copyright__inner">
						...
						<a href="<?php echo site_url('User'); ?>"><img src="<?= base_url('assets/user/images/logo/logo2.png') ?>" alt="allshop baju kebaya"></a>
					</div>
				</div>
			</div>
		</div>
