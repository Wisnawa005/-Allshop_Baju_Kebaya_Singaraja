							...
							<nav class="main__menu__nav hidden-xs hidden-sm">
								<ul class="main__menu">
									...
									<li class="drop"><a href="#">Produk</a>
										<ul class="dropdown">
											<li><a href="<?= base_url('user/product_grid') ?>">Product Grid</a></li>
											<li><a href="<?= base_url('user/detail_keranjang_belanja') ?>">cart</a></li>
											<li><a href="<?= base_url('user/checkout') ?>">checkout</a></li>
											<li><a href="<?= base_url('user/wishlist') ?>">wishlist</a></li>
										</ul>
									</li>
									<!-- <li class="drop"><a href="<?= base_url('user/blog') ?>">blog</a></li> -->
						...
						<div class="mobile-menu clearfix visible-xs visible-sm">
							<nav id="mobile_dropdown">
								<ul>
									...
									<li><a href="#">pages</a>
										<ul>
											<li><a href="<?= base_url('user/detail_keranjang_belanja') ?>">Cart page</a></>
											<li><a href="<?= base_url('user/checkout') ?>">checkout</a></li>
											<li><a href="<?php echo site_url('user/kontak'); ?>">contact</a></li>
											<li><a href="<?= base_url('user/product_grid') ?>">product grid</a></li>
											<li>
												<?php echo anchor('user/wishlist') ?>
											</li>
										</ul>
									</li>
									<li><a href="<?php echo site_url('user/kontak'); ?>">contact</a></li>
