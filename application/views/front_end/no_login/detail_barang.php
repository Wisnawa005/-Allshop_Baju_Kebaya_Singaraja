					...
					<?php foreach ($barang as $val) : ?>
						<div class="ht__product__dtl">
							...
							<ul class="pro__prize">
								...
								<li>Rp. <?php echo number_format($val->harga_jual, 0, ',', '.') ?></li>
							</ul>
							...
							<div class="ht__pro__desc">
								...
								<div class="sin__desc align--left">
									<div class="buttons-cart checkout--btn">
										<?= anchor('User/tambah_ke_keranjang/' . $val->kode_barang, '<i class="icon-handbag icons"> <b>TAMBAH KERANJANG</b></i>') ?>
										<?= anchor('User', '<i class="icon-handbag icons"> <b>BACK</b></i>') ?>
									</div>
								</div>
							<?php endforeach ?>
							</div>
