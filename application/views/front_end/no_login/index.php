	  ...
	  <h2>
	  	<center><b>
	  			<?php if ($this->session->flashdata('no_login')) {
						...
						echo $this->session->flashdata('no_login');
						echo '</div>';
					} ?>
	  		</b>
	  	</center>
	  						...
	  						<div class="category">
	  							...
	  							<div class="fr__hover__info">
	  								<ul class="product__action">
	  									...
	  									<!-- link detail berang -->
	  									<li>
	  										<?php echo anchor('User/detail_barang/' . $brg->kode_barang, '<i class="icon-info icons"></i>') ?>
	  									</li>
	  								</ul>
	  							</div>
	  							<!-- fitur menambah tambah_ke_keranjang -->
	  							...
	  							<div class="fr__product__inner">
	  								<h4>
	  									<a href="<?php echo site_url('User/detail_barang/' . $brg->kode_barang); ?>"><?php echo $brg->nama_barang ?></a>
	  								</h4>
